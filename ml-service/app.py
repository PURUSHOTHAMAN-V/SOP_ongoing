...
def init_database():
    """Initialize SQLite database for storing item features"""
...
def detect_fraud():
    ...
    try:
        ...
        fraud_score = calculate_fraud_score_based_on_matching(
            item_name, description, category, location, user_id, item_type
        )
